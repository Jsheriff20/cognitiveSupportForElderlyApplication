...
public class PairGame8ButtonsActivity extends AppCompatActivity {
    ...
    ImageButton btnGrid1Of8, btnGrid2Of8, btnGrid3Of8, btnGrid4Of8,
            btnGrid5Of8, btnGrid6Of8, btnGrid7Of8, btnGrid8Of8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageButtonsList.addAll(Arrays.asList(
                btnGrid1Of8, btnGrid2Of8, btnGrid3Of8, btnGrid4Of8,
                btnGrid5Of8, btnGrid6Of8, btnGrid7Of8, btnGrid8Of8
        ));
                        ...
                        if(mButtonAndImageMap.get(button).equals(firstImage)){
                            ...
                            if(mNumberCorrect == (mImageButtonsList.size() / 2)){
                                ...
                                if(mStreak < 4) {
                                    ...
                                    Intent intent = new Intent(PairGame8ButtonsActivity.this,
