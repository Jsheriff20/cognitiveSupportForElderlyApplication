...
public class ManageAdminActivity extends AppCompatActivity {
    ...
    ManagingFriends mManagingFriends = new ManagingFriends(this, null);
    ...
    private void setupSpinner() {
        ...
        mQueryingDatabase.getFriendsAndAdminFriendsNames(
                new QueryingDatabase.OnGetFriendsNamesListener() {
                    @Override
                    public void onSuccess(HashMap<String, String> friends,
                                          HashMap<String, String> adminFriends) {
                        mFriends = friends;
                        ...
                        ArrayAdapter<String> arrayAdapter =
                                new ArrayAdapter<String>(ManageAdminActivity.this,
                                        R.layout.spinner_item, friendsNames);
                        arrayAdapter.setDropDownViewResource(R.layout.spinner_item);
                        spnPossibleAdminFriends.setAdapter(arrayAdapter);
                        spnPossibleAdminFriends
    ...
    private void setupRecyclerView() {
        ...
        //display to user
        mQueryingDatabase
                .getFriendsAndAdminFriendsNames(new QueryingDatabase.OnGetFriendsNamesListener() {
                    @Override
                    public void onSuccess(HashMap<String, String> friends,
                                          HashMap<String, String> adminFriends) {
                ...
                mQueryingDatabase.getFriendsAndAdminFriendsNames(
                        new QueryingDatabase.OnGetFriendsNamesListener() {
                            ...
                            public void onSuccess(HashMap<String, String> friends,
                                ...
                                Set<String> UUIDs = getKeyByValue(friends, mFriendsName);
                                String UUID = UUIDs.iterator().next();

                                //add friend and refresh
                                mManagingFriends.addFriendAsAdmin(UUID,
                                        new ManagingFriends.OnAdminFriendAddedListener() {
                                            @Override
